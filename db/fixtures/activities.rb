Activity.seed(:id,
  ...
  { position: 4, id: 3, name: 'Siatkówka',   icon_white: File.open(Rails.root.join("db/icons/valleyball_white.png")), icon_blue: File.open(Rails.root.join("db/icons/valleyball_white.png"))    },
